  ...
  async up(queryInterface, Sequelize) {
    ...
    const users = [
      // System Admin
      {
        ...
        role: 'ADMIN',
        otp_verified: true,
        profile_image: 'admin_avatar.jpg',
      ...
      // Charity 1 (Đã xác thực)
      {
        ...
        role: 'CHARITY',
        otp_verified: true,
        profile_image: 'charity_act1.jpg',
        province: 'Hồ Chí Minh',
        district: 'Quận 3',
        ward: 'Phường 1',
      ...
      // Charity 2 (Đã xác thực)
      {
        ...
        role: 'CHARITY',
        otp_verified: true,
        profile_image: 'charity_act2.jpg',
        province: 'Hồ Chí Minh',
        district: 'Quận 3',
        ward: 'Phường 7',
      ...
      // Charity 3 (Đã xác thực)
      {
        ...
        role: 'CHARITY',
        otp_verified: true,
        profile_image: 'charity_act3.jpg',
        province: 'Hồ Chí Minh',
        district: 'Quận 3',
        ward: 'Phường 7',
      ...
      // Charity 4 (Đã xác thực)
      {
        ...
        role: 'CHARITY',
        otp_verified: true,
        profile_image: 'charity_act4.jpg',
        province: 'Hồ Chí Minh',
        district: 'Quận 3',
        ward: 'Phường 7',
      ...
      // Charity 5 (Đã xác thực)
      {
        ...
        role: 'CHARITY',
        otp_verified: true,
        profile_image: 'charity_act5.jpg',
        province: 'Hồ Chí Minh',
        district: 'Quận 3',
        ward: 'Phường 5',
      ...
      // Charity 6 (Đã xác thực)
      {
        ...
        role: 'CHARITY',
        otp_verified: true,
        profile_image: 'charity_act6.jpg',
        province: 'Hồ Chí Minh',
        district: 'Quận 3',
        ward: 'Phường 3',
      ...
      // Charity 7 (Đang chờ xác thực)
      {
        ...
        role: 'CHARITY',
        otp_verified: true,
        profile_image: 'charity_inac2.jpg',
        province: 'Hồ Chí Minh',
        district: 'Quận 3',
        ward: 'Phường 4',
        address: '123 Đường Trần Quốc Thảo',
      ...
      // Charity 8 (Đang chờ xác thực)
      {
        ...
        role: 'CHARITY',
        otp_verified: true,
        profile_image: 'charity_pen1.jpg',
        province: 'Hồ Chí Minh',
        district: 'Quận 3',
        ward: 'Phường 5',
        address: '45 Đường Nguyễn Đình Chiểu',
      ...
      // Charity 9 (Bị từ chối xác thực)
      {
        ...
        role: 'CHARITY',
        otp_verified: true,
        profile_image: 'charity_rej1.jpg',
        province: 'Hồ Chí Minh',
        district: 'Quận 3',
        ward: 'Phường 6',
        address: '67 Đường Trần Quốc Thảo',
      ...
      // Charity 10 (Bị từ chối xác thực)
      {
        ...
        role: 'CHARITY',
        otp_verified: true,
        profile_image: 'charity_rej2.jpg',
        province: 'Hồ Chí Minh',
        district: 'Quận 3',
        ward: 'Phường 6',
        address: '67 Đường Trần Quốc Thảo',
